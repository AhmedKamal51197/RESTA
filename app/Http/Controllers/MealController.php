...
class MealController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        //         ->where('size', $mealSizeCostData['size'])
        //         ->where('id', '!=', $id)
        //         ->first();
        
        //     if ($existingSizeCost) {
        //         return response()->json(['message' => 'This size already exists for another record of the same meal.'], 400);
        //     } else {
        //         $meal->mealSizeCosts()->where('id', $id)->update($mealSizeCostData);
        //     }
        // }
