...
Route::group(['middleware'=>'checkAdminToken'],function(){
    ...
    //logout 
    //get all admin
    Route::get('admin/admins',[EmployeeController::class,'indexAdmin']);
     //get all employees
     Route::get('admin/employees',[EmployeeController::class,'indexEmployee']);

     // filter admin
     Route::get('admin/admins-filter', [EmployeeController::class, 'filterAdmin']);
    // filter employee
    Route::get('admin/employees-filter', [EmployeeController::class, 'filterEmployee']);
